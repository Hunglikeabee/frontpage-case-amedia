...
//Error on new URL, adding additional "/" at start of filepath making it crash.
//This was a workaround
const fixUrlBrokenURL = pkgJSONPath.slice(1)
const pckage = JSON.parse(fs.readFileSync(fixUrlBrokenURL, 'utf8'));
